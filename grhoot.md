...
* Comparing each figure from the RetFig ontology if it exists in German.
...
* Completeness and Consistency Check: Competency questions as DL and SPARQL queries to ensure that the ontology works as expected.
